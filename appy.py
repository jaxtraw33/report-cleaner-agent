...
with col1:
    ...
    default_draft = "Yesterday around 3:15pm the database server completely crashed because sum dumb-ass uploaded the wrong config script. We lost about 45 mins of downtime on line 2. Fixed it by 4pm and back running fine."
